...
import { Heartbeat, LocalizationRoute, MetricsRoute, LicenseBeat, ConfigBeat } from "./routes";
...
export class Router implements PkApi.IRouter {
  ...
  protected localization: LocalizationRoute | undefined;
  ...
  public initRoutes(): void {
    ...
    this.localization = new LocalizationRoute(this.app);
